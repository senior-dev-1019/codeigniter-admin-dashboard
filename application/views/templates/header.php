        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo site_url(); ?>clients/"><i class="fas  fa-eye fa-sm"></i> Klanten overzicht</a>
                        <!-- <a class="collapse-item" href="<?php echo site_url(); ?>clients_notes"><i class="fas  fa-notes fa-sm"></i> Notities</a> -->
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo site_url(); ?>appointments/"> Overzicht</a>
                        <a class="collapse-item" href="<?php echo site_url(); ?>calendar/">Toevoegen</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUsers" class="collapse" aria-labelledby="headingUsers"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo site_url(); ?>users/register">Toevoegen</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Finance Collapse Menu -->
