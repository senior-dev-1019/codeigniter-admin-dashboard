...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-users"></i> <?php echo $title; ?></h1>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                      <?php foreach ($clients as $clients_item): ?>
                          <tr>
                              ...
                              <td><a href="<?= '/clients/'.$clients_item['client_id']; ?>"><?= $clients_item['first_name']; ?></a></td>
                              <td><a href="<?= '/clients/'.$clients_item['client_id']; ?>"><?= $clients_item['last_name']; ?></a></td>
